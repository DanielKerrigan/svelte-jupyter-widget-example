...
# -*- coding: utf-8 -*-
#
# svelte_widget documentation build configuration file
#
...
_version_py = os.path.join(repo, 'svelte_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'svelte_widgetdoc'
...
latex_documents = [
    (master_doc, 'svelte_widget.tex', 'svelte_widget Documentation',
     'me', 'manual'),
]
